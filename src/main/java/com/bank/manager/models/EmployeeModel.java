...
public class EmployeeModel {
	...
	@NotBlank
	@Length(min=4, max=30, message="Le nom doit etre compris entre 4 et 30.")
	private String nom;
	@NotBlank
	@Length(min=4, max=30, message="Le prenom doit etre compris entre 4 et 30.")
	...
	public EmployeeModel(String nom, String prenom, int age, String email,
			String ville, String quartier, int code_postale, int numero_lieu) {
		super();
		this.nom = nom;
		this.prenom = prenom;
		this.age = age;
